  ...
  config({
    ...
    session,
     server: {
       cors: {
         ...
         "https://thecapetownlocalfe-production.up.railway.app", "https://www.thecapetownlocal.com"],
         credentials: true
        },
    ...
    //   // },
      local_images: {
        ...
        generateUrl: path => `${process.env.NODE_ENV==='production'? process.env.PROD_URL+process.env.RAILWAY_VOLUME_MOUNT_PATH:process.env.ASSET_BASE_URL+'/images'}${path}`,
